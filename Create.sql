...
CREATE TABLE Recommendation(
    ...
    CONSTRAINT Rec_comment CHECK (CHAR_LENGTH(`Comment`) >= 15),
...
CREATE TABLE Favorites (
    ...
    CONSTRAINT Favourites_username  FOREIGN KEY (Username) REFERENCES `Admin`(Username) ON DELETE CASCADE ON UPDATE CASCADE,
